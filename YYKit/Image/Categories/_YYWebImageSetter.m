...
- (int32_t)setOperationWithSentinel:(int32_t)sentinel
   ...
   if (!operation && completion) {
      ...
      completion(nil, imageURL, YYWebImageFromNone, YYWebImageStageFinished, [NSError errorWithDomain:@"com.idea.foundation.webimage" code:-1 userInfo:userInfo]);
   }
...
+ (dispatch_queue_t)setterQueue {
   ...
   dispatch_once(&onceToken, ^{
      queue = dispatch_queue_create("com.idea.foundation.webimage.setter", DISPATCH_QUEUE_SERIAL);
